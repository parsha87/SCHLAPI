...
{
    public partial class RechableNode
    {
        [Key]
        ...
        public int? AutoSensorStatusSendInterval { get; set; }
        public int? SamplingTimeInterval { get; set; }
        [Column("ApplicationENBits")]
        public int? ApplicationEnbits { get; set; }
        [Column("TimeForNOCommWithGW")]
        public int? TimeForNocommWithGw { get; set; }
